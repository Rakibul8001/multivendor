...
//Testing home page
Route::get('/testhome', 'TesthomeController@index')->name('front.home');
Route::get('/all_brands', 'TesthomeController@brands_all')->name('all.brands');
// Route::get('/allbrands/{brand_slug}', 'TesthomeController@listingWithBrand')->name('allproducts.brand');
Route::get('/all_product_listing/{brand_slug}', 'TesthomeController@listingWithBrand')->name('allproducts.brand');
Route::get('/all_categories', 'TesthomeController@categories_all')->name('all.categories');
Route::get('/allproduct_by_category/{category_slug}', 'TesthomeController@listingWithCategory')->name('allproducts.category');
Route::get('/product-details/{slug}', 'TesthomeController@productDetails')->name('product.details');
//Blog Section
Route::get('/all_blogs', 'BlogController@blogs_all')->name('blog.all');
Route::get('/all_blog/{slug}', 'BlogController@details_blogs')->name('details.blogs');
//Fash deal
Route::get('/flashdeals', 'TesthomeController@flash_deals_all')->name('flashdeals.all');
Route::get('/flash-deal/{id}', 'TesthomeController@flashdeal_details')->name('flashdeal-details');
