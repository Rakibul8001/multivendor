                        ...
                        <li class="list-group-item px-0">
                                ...
                                <a class="media-left" href="#">
                                    @if($ticketreply->user->avatar_original != null)
                                        <span class="avatar avatar-sm mr-3">
                                            <img src="{{ asset($ticketreply->user->avatar_original) }}" onerror="this.onerror=null;this.src='{{ asset('assets/img/avatar-place.png') }}';">
                                        </span>
                                    @else
                                        <span class="avatar avatar-sm mr-3">
                            ...
                            <div>
                                ...
                                @foreach ((explode(",",$ticketreply->files)) as $key => $file)
                                    ...
                                    @if($file_detail != null)
                                        <a href="{{ asset($file) }}" download="" class="badge badge-lg badge-inline badge-light mb-1">
                        ...
                        <div class="media">
                            <a class="media-left" href="#">
                                @if($ticket->user->avatar_original != null)
                                    <span class="avatar avatar-sm mr-3">
                                        <img src="{{ asset($ticket->user->avatar_original) }}" onerror="this.onerror=null;this.src='{{ asset('assets/img/avatar-place.png') }}';">
                                    </span>
                                @else
                                    <span class="avatar avatar-sm mr-3">
                                        <img src="{{ asset('assets/img/avatar-place.png') }}">
