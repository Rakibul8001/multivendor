                ...
                <div class="col-md-6 mx-auto">
                    <div class="d-flex justify-content-center">
                        <img
                            ...
                            data-src="@if ($shop->logo !== null) {{ asset($shop->logo) }} @else {{ asset('assets/img/placeholder.jpg') }} @endif"
                            alt="{{ $shop->name }}"
                        >
                    ...
                    @if ($shop->sliders != null)
                        @foreach (explode(',',$shop->sliders) as $key => $slide)
                            <div class="carousel-box">
                                <img class="d-block w-100 lazyload rounded h-200px h-lg-380px img-fit" src="{{ asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ asset($slide) }}" alt="{{ $key }} offer">
                            </div>
                        @endforeach
                    @endif
                </div>
