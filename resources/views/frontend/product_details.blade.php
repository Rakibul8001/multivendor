                            ...
                            <div class="aiz-carousel product-gallery-thumb" data-items='5'
                                ...
                                <div class="carousel-box c-pointer border p-1 rounded">
                                    <img class="lazyload mw-100 size-50px mx-auto"
                                        src="{{ asset('assets/img/placeholder.jpg') }}" data-src="{{ asset($photo) }}"
                                        onerror="this.onerror=null;this.src='{{ asset('assets/img/placeholder.jpg') }}';">
                                </div>
                                @endforeach
                                @foreach ($detailedProduct->stocks as $key => $stock)
                    ...
                    <div class="text-left">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                @if ($detailedProduct->added_by == 'seller' && get_setting('vendor_system_activation')==
                                1)
                            ...
                            <div class="col-auto">
                                <a href="{{ route('products.brand',$detailedProduct->brand->slug) }}">
                                    <img src="{{ asset($detailedProduct->brand->logo) }}"
                            ...
                            <div class="row no-gutters">
                                <div class="col-sm-2">
                                    <div class="opacity-50 my-2">
                                        {{ \App\Attribute::find($choice->attribute_id)->getTranslation('name') }}:</div>
                                </div>
                                <div class="col-sm-10">
                    ...
                    <div class="tab-content pt-0">
                        ...
                        <div class="tab-pane fade" id="tab_default_3">
                            <div class="p-4 text-center ">
                                <a href="{{ asset($detailedProduct->pdf) }}"
