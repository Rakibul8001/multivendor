		...
		<div class="card">
			...
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
                        <label for="inputPhoto" class="col-form-label col-md-3">Header Logo <span class="text-danger">*</span></label>
                        <div class="input-group col-md-9">
							...
							<input type="hidden" name="types[]" value="header_logo">
                        <input id="thumbnail" class="form-control" type="text" name="header_logo" value="{{ get_setting('header_logo') }}">
                        </div>
