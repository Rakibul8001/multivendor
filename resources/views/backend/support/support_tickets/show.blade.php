                            ...
                            <div class="media">
                                <a class="media-left" href="#">
                                    @if($ticketreply->user->avatar_original != null)
                                        <span class="avatar avatar-sm mr-3"><img src="{{ asset($ticketreply->user->avatar_original) }}"></span>
                                    @else
                        ...
                        <div class="media">
                            <a class="media-left" href="#">
                                @if($ticket->user->avatar_original != null)
                                    <span class="avatar avatar-sm m-3"><img src="{{ asset($ticket->user->avatar_original) }}"></span>
                                @else
