                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="thumbnail" class="form-control" type="text" name="photos" value="{{old('photos')}}">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfmn" data-input="thumbnail1" data-preview="holder" class="btn btn-primary">
                                        <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                <input id="thumbnail1" class="form-control" type="text" name="thumbnail_img" value="{{old('thumbnail_img')}}">
                                </div>
                                <div id="holder" style="margin-top:15px;max-height:100px;"></div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <a id="lfmm" data-input="thumbnail2" data-preview="holder" class="btn btn-primary">
                                        <i class="fa fa-picture-o"></i> Choose
                                        </a>
                                    </span>
                                <input id="thumbnail2" class="form-control" type="text" name="meta_img" value="{{old('meta_img')}}">
                                </div>
                                <div id="holder" style="margin-top:15px;max-height:100px;"></div>
