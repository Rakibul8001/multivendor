                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="thumbnail" class="form-control" type="text" name="photos" value="{{$product->photos}}">
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input id="thumbnail2" class="form-control" type="text" name="thumbnail_img" value="{{$product->thumbnail_img }}">
                                </div>
                                <div id="holder" style="margin-top:15px;max-height:100px;"></div>
...
<!--                <div class="card">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputPhoto" class="col-form-label col-md-3">Meta Images <span class="text-danger">*</span></label>
                            <div class="input-group col-md-8">
                                <span class="input-group-btn">
                                    <a id="lfmm" data-input="thumbnail3" data-preview="holder" class="btn btn-primary">
                                    <i class="fa fa-picture-o"></i> Choose
                                    </a>
                                </span>
                            <input id="thumbnail3" class="form-control" type="text" name="meta_img" value="{{ $product->meta_img }}">
                            </div>
                            <div id="holder" style="margin-top:15px;max-height:100px;"></div>
                        </div>
