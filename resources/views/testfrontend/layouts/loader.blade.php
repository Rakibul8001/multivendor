                        ...
                        <div class="menu-left">
                            ...
                            <div class="brand-logo">
                                ...
                                <a href="{{ route('front.home') }}"><img src="{{ asset($header_logo) }}"
                                        class="lazyload mw-100 h-30px h-md-40px" alt="{{ env('APP_NAME') }}"
                                        height="40"></a>
                                @else
                            ...
                            <div>
                                <nav>
                                    ...
                                    <ul class="sm pixelstrap sm-horizontal">
                                        ...
                                        @foreach (json_decode( get_setting('header_menu_labels'), true) as $key =>
                                        $value)
                                        <li>
                                            <a
