...
@section('front-content') 
    ...
    <section class="blog-detail-page section-b-space ratio2_3">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 blog-detail"><img src="{{asset($blog->banner)}}"
            ...
            <div class="row section-b-space blog-advance">
                <div class="col-lg-6">
                    <div><img src="{{asset($blog->banner)}}" class="img-fluid blur-up lazyload bg-img" alt=""></div>
                </div>
                <div class="col-lg-6">
                    <div><img src="{{asset($blog->banner)}}" class="img-fluid blur-up lazyload bg-img" alt=""></div>
                </div>
            ...
            <div class="row section-b-space">
                <div class="col-sm-12">
                    <ul class="comment-section">
                        <li>
                            <div class="media"><img src="{{asset('frontend/assets/images/avtar.jpg')}}" alt="Generic placeholder image">
                        ...
                        <li>
                            <div class="media"><img src="{{asset('frontend/assets/images/2.jpg')}}" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                                        fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer
                        ...
                        <li>
                            <div class="media"><img src="{{asset('frontend/assets/images/20.jpg')}}" alt="Generic placeholder image">
                                <div class="media-body">
                                    <h6>Mark Jecno <span>( 12 Jannuary 2018 at 1:30AM )</span></h6>
                                    <p>Donec rhoncus massa quis nibh imperdiet dictum. Vestibulum id est sit amet felis
                                        fringilla bibendum at at leo. Proin molestie ac nisi eu laoreet. Integer
